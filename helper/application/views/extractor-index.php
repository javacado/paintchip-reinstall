...
<!-- 
        ...
        <button class='btn btn-default' onclick='getCatz()'>Get Catz</button>
 ...
 -->
        ...
        <div class='row approveprices' style='display: none'>
            ...
            <div class='col-md-6 '>
                ...
                <div id='lg-img' onclick="$(this).html('')"></div>
 ...
 -->
        ...
        <script>
            ...
            function getHTML(line, gooddata) {
                ...
                var stuff = "";
                if (gooddata) {
                    stuff = " class='csv-data' data-id='" + line.id + "' data-title='" + line.title + "'  data-stock='" + line.stock + "' data-price='" + line.theprice + "' data-linedata='" + line.linedata + "' data-category=' " + line.category + "' ";
                }
            ...
            function getCatz() {
                ...
                $.ajax({
                    url: "/helper/extractor/getCategoriesFromSLS/",
                    context: document.body,
                    method: 'get'
                }).done(function(res) {
                    res = JSON.parse(res);
            ...
            function extract() {
                ...
                $.ajax({
                    url: "/helper/extractor/getCSV/Inventory_Master_Processed.csv",
                    context: document.body,
                    method: 'get'
                }).done(function(res) {
                    console.log('done');
                    ...
                    $("#title").html(res.allitems.length + " FOUND")
                    for (var x = 0; x < res.allitems.length; x++) {
                        line = res.allitems[x]
            ...
            function get_supplier_data(ctr) {
                ...
                id = id.replace(/\W/g, '');
                var origid = $(data).attr('data-origid') ? $(data).attr('data-origid') : "";
                ...
                var linedata = $(data).attr('data-linedata')
